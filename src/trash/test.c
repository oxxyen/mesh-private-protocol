// /*
//  * ULTRA SECURE P2P MESSENGER SERVER v4.0 - FIXED VERSION
...
// #define _GNU_SOURCE
// #define _FORTIFY_SOURCE 2  // Добавлено для устранения ошибки
...
// #include <signal/ciphertext.h>  // Добавлено для ciphertext_message функций
